...
> **Status note (2026-08-01):** this design brief previously lived at the
> repo's `README.md` path, where it was invisible as project documentation
> and shadowed the real README. Moved here unchanged during a docs
> reconciliation pass. The feature is **partially shipped** —
