...
(function () {
  ...
  var programs = [
    ...
    { id: 'ks',   icon: '🔥', name: 'Everything Under the Kitchen Sink', meta: '4 Splits · 4 Weeks Each · Station-Anchored', color: '#f59e0b', desc: 'Four distinct training splits under one roof — the complete MC arsenal, station-anchored for commercial gym efficiency.', href: 'cat-ks.html', splits: ['Everything Under the Kitchen Sink', 'Iron Engine', 'Split 3', 'Split 4'] },
