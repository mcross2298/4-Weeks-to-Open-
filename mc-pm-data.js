...
(function () {
  ...
  var programs = [
    ...
    { id: 'ks',   icon: '🔥', name: 'Everything But The Kitchen Sink', meta: '4-Week · 5-On 2-Off · Station-Anchored', color: '#f59e0b', desc: 'The complete arsenal — tri-sets, clusters, drop sets, AMRAP finishers, and a Conditioning Day. Station-anchored for commercial gym efficiency.', href: 'kitchen-sink.html', splits: ['Chest & Biceps', 'Shoulders & Triceps', 'Back & Traps', 'Legs', 'Conditioning Day'] },
