...
(function () {
  ...
  var programs = [
    ...
    { id: 'mm',   icon: '⬡',  name: 'The Modality Matrix',            meta: '12 Weeks · 3 Phases · 4-Day Split',   color: '#6366f1', desc: 'Three phases, three modalities — dumbbell isolation, barbell strength, cable conditioning — one complete system.', href: 'cat-mm.html', splits: ['Phase 1 · Dumbbell', 'Phase 2 · Barbell', 'Phase 3 · Cable'] }
